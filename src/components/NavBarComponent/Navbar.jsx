  ...
  return (
    ...
    <div className='my-6'>
      ...
      <form className=' mt-2'>
        ...
        <button className='flex w-full items-center justify-center bg-orange-500 p-2 text-sm uppercase text-white hover:bg-orange-400 mt-6'>
          Áp dụng
        </button>
        <div className='my-4 h-[1px] bg-gray-300' />
        {/* đường kẻ ngang */}
          ...
          <li className='py-1 pl-2'>
            <Link to="" className='flex items-center text-sm'>
              {Array(5)
                .fill(0)
                .map((_, index) => (
                  <svg viewBox='0 0 9.5 8' className='mr-4 h-4 w-4' key={index}>
                    <defs>
    ...
    <div className='my-4 h-[1px] bg-gray-300' />
    {/* đường kẻ ngang */}
    <button className='flex w-full items-center justify-center bg-orange-500 p-2 text-sm uppercase text-white hover:bg-orange-400'>
      Xóa tất cả
    </button>
  </div>
  )
